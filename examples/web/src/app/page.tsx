    ...
    <div className="container">
      ...
      <section className="demo-section">
        ...
        <div className="button-group">
          ...
          <button type="button" className="button" onClick={handleMultilineInput}>
            Multiline Text
          </button>
      ...
      <section className="demo-section">
        ...
        <p className="demo-description">
          Experience a multi-step input flow where each prompt builds on the previous one.
        </p>
        <div className="button-group">
          <button type="button" className="button" onClick={handleSequentialInputs}>
          ...
          <div className="result-box">
            ...
            {results.rating !== undefined && (
              <div>
                ...
                <div className="result-value">{'⭐'.repeat(results.rating)}</div>
              </div>
            )}
